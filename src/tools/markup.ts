...
class MatchInner {
  ...
  mention(): DiscordRegexPayload<MentionableMatch> {
    return this.match(DiscordRegexNames.MENTION);
  }
...
export class Match extends MatchInner {
  ...
  static mention(raw: string) {
    return new this(raw).mention();
  }
